      ...
      <div className="row flex-nowrap">
        <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
          <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            <Link to="/" onClick={e => e.preventDefault()} className="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-white text-decoration-none">
            ...
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
              ...
              <li>
                <Link to="#submenu1" data-bs-toggle="collapse" className="nav-link px-0 align-middle" aria-expanded="false">
                  <i className="fs-4 bi-speedometer2"></i> <span className="ms-1 d-none d-sm-inline">Dashboard</span> <i className="fa-solid fa-arrow-down"></i></Link>
              ...
              <li>
                <Link to="/admin/genre" className="nav-link px-0 align-middle">
                  <i className="fs-4 bi-people"></i> <span className="ms-1 d-none d-sm-inline">Thể loại</span> </Link>
              </li>
            </ul>
            <hr />
            <div className="dropdown pb-4">
              <Link to="#" className="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown">
